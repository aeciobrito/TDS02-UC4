-- Garante que os comandos serão executados no banco de dados correto.
USE EstacionamentoDB;

-- -----------------------------------------------------
-- Inserção de Clientes
-- Populando a tabela `Cliente` com dados iniciais.
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Inserção de Vagas
-- Populando a tabela `Vaga` com diferentes tipos e localizações.
-- -----------------------------------------------------
INSERT INTO Vaga (localizacao, tipoVaga) VALUES
('A-01', 'Média'),
('A-02', 'Média'),
('B-05', 'Grande'),
('C-10', 'Pequena'), -- Vaga para moto
('B-06', 'Grande');

-- -----------------------------------------------------
-- Inserção de Veículos
-- Populando a tabela `Veiculo` e associando-os aos clientes.
-- Note que a Cliente com codCliente=2 (Maria Oliveira) terá dois veículos.
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Inserção de Registros de Estacionamento
-- Criando um histórico diversificado de utilização das vagas.
-- -----------------------------------------------------
...
-- Cenário 3: Outro registro finalizado para o mesmo carro do João, mostrando histórico.
